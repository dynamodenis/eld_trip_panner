...
class RouteService:
    def __init__(self):
        ...
        self.api_key = "Your_OpenRouteService_API_Key"  # Get from https://openrouteservice.org/
    ...
    def calculate_trip_details(self, current_location, pickup_location, dropoff_location, current_cycle_used):
        """Calculate the full trip with ELD considerations"""
        # Get route to pickup
        ...
        # Process routes and calculate ELD-compliant breaks and stops
        # This will be a simplified version - real implementation would be more complex
        return {
            "to_pickup": to_pickup,
            "pickup_to_dropoff": pickup_to_dropoff,
            "total_distance": self._calculate_total_distance(to_pickup, pickup_to_dropoff),
            "total_duration": self._calculate_total_duration(to_pickup, pickup_to_dropoff),
            "stops": self._calculate_required_stops(to_pickup, pickup_to_dropoff, current_cycle_used)
        }
    ...
    def _calculate_total_distance(self, route1, route2):
        ...
        distance1 = route1['routes'][0]['summary']['distance'] if 'routes' in route1 else 0
        distance2 = route2['routes'][0]['summary']['distance'] if 'routes' in route2 else 0
    ...
    def _calculate_total_duration(self, route1, route2):
        ...
        duration1 = route1['routes'][0]['summary']['duration'] if 'routes' in route1 else 0
        duration2 = route2['routes'][0]['summary']['duration'] if 'routes' in route2 else 0
    ...
    def _calculate_required_stops(self, route1, route2, current_cycle_used):
        ...
        ten_hour_breaks = math.ceil(max(0, (total_duration - remaining_drive_time)) / 11)
